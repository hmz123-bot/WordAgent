...
public class DeepSeekProvider implements AiProvider {
    ...
    @Value("${ai.deepseek.endpoint:https://api.deepseek.com/v1/chat/completions}") private String endpoint;
    ...
    public ChatResponse chat(ChatRequest req) {
        ...
        try {
            ...
            log.error("DeepSeek sync call failed", e);
    ...
    @Override public ModelRouter.ModelSelection modelType() { return ModelRouter.ModelSelection.DEEPSEEK; }
